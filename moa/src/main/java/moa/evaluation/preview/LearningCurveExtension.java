 ...
 * @version $Revision: 7 $
 */
public class LearningCurveExtension extends Preview {
    ...
    public LearningCurveExtension(String orderingMeasurementName) {
        this.measurementNames.add(orderingMeasurementName);
    }

    public LearningCurveExtension(String orderingMeasurementName, Class<?> taskClass) {
        this.measurementNames.add(orderingMeasurementName);
...
//        }
        ...
        this.measurementValues.add(entryVals.getArrayRef());
    }
